...
public class DialogueMap {
    ...
    public DialogueMap() {
        ...
        this.dialogueMap.put(DialoguePath.SUCCESSFULLY_ADDED_TASK, "Added: {r:0} to the list");
        this.dialogueMap.put(DialoguePath.ADD_TASK_STORAGE_FAILURE,
                "Added: {r:0} to the list" + SEP
                        + "Woah, hold on..." + SEP
        ...
        this.dialogueMap.put(DialoguePath.SUCCESSFULLY_DELETED_TASK, "Deleted: {r:0} from the list");
        this.dialogueMap.put(DialoguePath.DELETE_TASK_STORAGE_FAILURE,
                "Deleted: {r:0} to the list" + SEP
                        + "Woah, hold on..." + SEP
                        + "I seem to be unable to save your changes." + SEP
                        + "Could you run the Save command?"
        );
        ...
        this.dialogueMap.put(DialoguePath.TASK_ALREADY_MARKED, "The task {r:0} is already marked!");
        ...
        this.dialogueMap.put(DialoguePath.TASK_NOT_MARKED, "The task {r:0} has not been marked yet!");
        this.dialogueMap.put(DialoguePath.SUCCESSFULLY_UNMARKED_TASK, "Okay! I have marked the task {r:0} as done.");
